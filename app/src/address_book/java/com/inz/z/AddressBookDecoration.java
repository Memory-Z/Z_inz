 ...
 */
public class AddressBookDecoration extends RecyclerView.ItemDecoration {
    ...
    public AddressBookDecoration(Context context, List<? extends ISuspensionInterface> datas) {
        this.mDatas = datas;
    ...
    public AddressBookDecoration setmTitleHeight(int mTitleHeight) {
        this.mTitleHeight = mTitleHeight;
        return this;
    }

    public AddressBookDecoration setColorTitleBg(int colorTitleBg) {
        COLOR_TITLE_BG = colorTitleBg;
        return this;
    }

    public AddressBookDecoration setColorTitleFont(int colorTitleFont) {
        COLOR_TITLE_FONT = colorTitleFont;
        return this;
    }

    public AddressBookDecoration setTitleFontSize(int mTitleFontSize) {
        this.mPaint.setTextSize((float)mTitleFontSize);
        return this;
    }

    public AddressBookDecoration setmDatas(List<? extends ISuspensionInterface> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    public AddressBookDecoration setHeaderViewCount(int headerViewCount) {
