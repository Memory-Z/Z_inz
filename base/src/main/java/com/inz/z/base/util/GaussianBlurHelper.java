 ...
 * @author Zhenglj
 * @version 1.0.0
 * Create by inz in 2019/06/11 11:11.
 */
public class GaussianBlurHelper {
     ...
     * @author lizhenya
     */
    public static Bitmap blur(Context context, Bitmap bitmap, boolean canReuseInBitmap) {
     ...
     * @param context          *            上下文
     * @param bitmap           *            待模糊的图片
     * @param bitmapScale      *            图片的压缩因子
     * @param canReuseInBitmap *            原始Bitmap是否还会使用（如果原始图片还会再次使用则参数设为true，否则会报出java.lang.
     *                         *            IllegalStateException异常，一般情况下设为true防止程序出错）
     * @return 模糊后的图片
     * @author lizhenya
     */
    public static Bitmap blur(Context context, Bitmap bitmap, float bitmapScale, boolean canReuseInBitmap) {
